...
$_lang['register.email_taken'] = 'Het e-mailadres "[[+email]]" is al in gebruik. Controleer of je niet al bent geregistreerd of probeer het met een ander e-mailadres.';
...
$_lang['register.math_incorrect'] = 'Verkeerd antwoord!';
$_lang['register.math_field_nf'] = 'Het invoerveld [[+field]] is niet gedefineerd in het formulier.';
...
$_lang['register.not_regexp'] = 'Dit invoerveld heeft een ongeldige waarde.';
...
$_lang['register.password_not_confirmed'] = 'Bevestig uw wachtwoord a.u.b.';
$_lang['register.range_invalid'] = 'Ongeldig bereik opgegeven.';
$_lang['register.range'] = 'Uw waarde moet tussen [[+min]] en [[+max]] zijn.';
$_lang['register.recaptcha_err_load'] = 'Kan de reCaptcha service klasse niet laden.';
...
$_lang['register.use_stronger_password'] = 'Het wachtwoord is niet sterk genoeg. Je kunt je wachtwoord versterken door bijvoorbeeld letters te vervangen door nummers en/of meer woorden toe te voegen (probeer een wachtwoord met meer woorden). Suggesties: [[+suggestions]]';
